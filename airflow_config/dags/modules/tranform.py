...
class Tranform():
    ...
    def get_data_from_mysql(self):
        ...
        print('DATA DARI SQL BERHASIL DI AMBIL')
        print(df)
        return df 
    ...
    def create_dimension_province(self):
        ...
        print("MEMASUKKAN DATA KE POSTGRES BERHASIL")
    ...
    def create_dimension_case(self):
        df = self.get_data_from_mysql()
        column_start = ['suspect_diisolasi','suspect_discarded',
                        'suspect_meninggal','closecontact_dikarantina',
                        'closecontact_discarded','probable_discarded',
                        'probable_diisolasi','closecontact_meninggal',
                        'probable_meninggal','confirmation_sembuh',
    ...
    def create_province_daily(self):
        ...
        print("MEMASUKKAN DATA PROVINSI HARIAN KE POSTGRES BERHASIL")
        
    def create_district_daily(self):
        df = self.get_data_from_mysql()
        df_case_dim = self.create_dimension_case()
        
        column_start = ['tanggal','kode_kab','suspect_diisolasi','suspect_discarded','closecontact_dikarantina','closecontact_discarded','closecontact_meninggal','probable_meninggal']
        ...
        print("MEMASUKKAN DATA KABUPATEN HARIAN KE POSTGRES BERHASIL")
